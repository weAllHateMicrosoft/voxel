...
class WindowHud {
    ...
    void renderHelpScreen(float screenW, float screenH) {
        ...
        helpRow("[F10]", "'Voxel Lines' (testing). A clay + neon-edge 'blueprint' restyle sweeps over YOUR world from where you stand: terrain turns cool matte clay, deepens to midnight blue with blazing cyan-white lines on every block edge, then fades back to normal — one ~6s cycle. (IQ-inspired, recoloured.)");
